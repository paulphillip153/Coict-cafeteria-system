...
<body>
    <div class="dashboard-container">
        <h2>Welcome Admin, <?php echo htmlspecialchars($_SESSION['admin']); ?>! at CoICT Cafeteria </h2>

        <div class="nav-links">
            <a href="../menu/menu.php">Manage Menu</a>
            <a href="../users/manage-users.php">Generate transaction report</a>
